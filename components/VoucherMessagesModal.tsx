...
interface VoucherMessagesModalProps {
  isOpen: boolean;
  onClose: () => void;
  voucherId: string;
}
...
/**
 * Voucher Messages Modal Component
 * 
 * Displays the message history for a voucher.
 * 
 * Args:
 ...
 */
export default function VoucherMessagesModal({
  isOpen,
  onClose,
  voucherId,
}: VoucherMessagesModalProps) {
