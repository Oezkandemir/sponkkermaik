    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {selectedSlot && (
          ...
          >
            <div className="bg-white rounded-none md:rounded-2xl shadow-2xl max-w-full md:max-w-md w-full h-full md:h-auto md:max-h-[95vh] flex flex-col md:block overflow-y-auto animate-in zoom-in-95 slide-in-from-bottom-4 duration-300">
              {/* Header with Close Button */}
              <div className="flex-shrink-0 bg-gradient-to-r from-amber-50 to-orange-50 border-b-2 border-amber-200 px-6 py-5 relative">
                ...
                <button
                  ...
                  className="absolute top-5 right-6 text-gray-400 hover:text-gray-600 transition-all duration-200 p-2 rounded-lg hover:bg-white/80 md:hidden"
                ...
                <button
                  ...
                  className="absolute top-5 right-6 text-gray-400 hover:text-gray-600 transition-all duration-200 p-2 rounded-lg hover:bg-white/80 hidden md:block"
                  aria-label="Schließen"
                >
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                ...
                <div className="text-center">
                  ...
                  {course && (
                    <div className="inline-flex items-center gap-2 bg-white px-4 py-2 rounded-lg border-2 border-amber-300 shadow-sm">
                      ...
                      <p className="text-lg font-bold text-amber-700">{course.price}</p>
                    </div>
                  )}
                  <p className="text-sm text-gray-600 mt-3">Bitte füllen Sie die folgenden Informationen aus</p>
                </div>
              </div>
              ...
              <div className="space-y-5 mb-6">
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900">
                    {t("customerName")} <span className="text-red-500 font-normal">*</span>
                  </label>
                  <input
                    type="text"
                    value={customerName}
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900">
                    {t("customerEmail")} <span className="text-red-500 font-normal">*</span>
                  </label>
                  <input
                    type="email"
                    value={customerEmail}
                    ...
                    {createAccount && (
                      <div className="mt-5 pt-5 border-t border-amber-300 animate-in fade-in slide-in-from-top-2 duration-300">
                        <label className="block text-sm font-semibold text-gray-900 mb-2">
                          {t("password")} <span className="text-red-500 font-normal">*</span>
                        </label>
                        <input
                          type="password"
                          value={password}
                ...
                <div className="space-y-2">
                  <label className="block text-sm font-semibold text-gray-900">
                    {t("notes")} <span className="text-gray-500 text-xs font-normal">({t("optional")})</span>
                  </label>
                  <textarea
                    value={notes}
              ...
              {message && (
                <div
                  className={`mb-5 p-4 rounded-xl text-sm border-2 animate-in fade-in slide-in-from-bottom-2 duration-300 ${
